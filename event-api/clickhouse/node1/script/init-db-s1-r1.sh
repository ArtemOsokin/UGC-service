...
clickhouse client -n <<-EOSQL
  ...
  CREATE MATERIALIZED VIEW IF NOT EXISTS default.films_bookmarks_mv TO db_shard1.films_bookmarks AS
  ...
  CREATE MATERIALIZED VIEW IF NOT EXISTS default.films_progress_mv TO db_shard1.films_progress AS
      SELECT *, _timestamp as timestamp, _key as key
  ...
  CREATE MATERIALIZED VIEW IF NOT EXISTS default.films_feedbacks_mv TO db_shard1.films_feedbacks AS
      SELECT *, _timestamp as timestamp, _key as key
