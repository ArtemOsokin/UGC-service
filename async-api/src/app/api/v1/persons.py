...
from app.api.v1.api_schemas import (APIFilmworksList, APIPersonDetail,
                                    APIPersonsList, Filter,
                                    GetFilmsByPersonKWARGS,
                                    GetPersonByIdKWARGS, Pagination, Params,
                                    SearchPersonsKWARGS)
...
async def filmworks_for_person(
    ...
    fil = Filter(actors=uuid, directors=uuid, writers=uuid)
    pagination = Pagination(page=page, limit=limit)
    params = Params(
